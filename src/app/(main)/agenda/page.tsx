...
export default function AgendaPage() {
  ...
  return (
    <div className="min-h-screen bg-[#000] w-full top-14 mb-20 z-0">
      <div className="sticky top-14 mt-0 fullscreen:p-[21px] z-20 bg-[#FFF] text-black font-neueMed w-full items-center justify-center hidden text-2xl tablet:flex tablet:text-[16px] fullscreen:text-[42px]">
      ...
      <div className=" sticky top-60 mt-0 z-0 w-full">
        <div className="flex font-neueMed text-[20px] fullscreen:text-[53px] gap-2 justify-start tablet:justify-center tablet:mb-8 sticky bg-[#000] w-full tablet:w-auto tablet:top-[88px] top-[58px] tablet:py-10 py-5 overflow-x-auto whitespace-nowrap px-4 overflow-y-hidden tablet:overflow-x-hidden hiddenScrollBar">
        ...
        <div className="flex flex-col tablet:flex-row justify-center tablet:gap-[100px] laptop:gap-[100px]">
          ...
          {day1.length || day2.length ? (
            <div className="flex flex-col">
              <div className="px-4 max-w-[947px] h-full w-full fullscreen:px-0 py-6 tablet:py-0 tablet:pb-[126px] fullscreen:pb-[328px] tablet:px-0 flex flex-col gap-2 items-center justify-center ">
                ...
                {day1.map((speaker, index) => (
                  ...
                  >
                    <div className="flex w-full tablet:w-auto justify-between items-center h-full py-4 px-5 tablet:p-0">
                      <div className="flex tablet:flex-col h-full w-full max-w-[167px] tablet:max-w-full gap-3 tablet:gap-4 tablet:w-11 items-center justify-between  text-[#474747]">
                        ...
                        <div className="flex h-full tablet:flex-col w-full justify-center items-center">
                          ...
                          <div className="flex tablet:h-full tablet:w-[1px]  w-full  items-center">
                            <div className="tablet:w-[1px] tablet:h-full h-[1px] w-full  tablet:border-l-2 border-t-2  border-dashed border-[#474747]" />
                          </div>
                          {/* Second Dot */}
            ...
            <div className="w-full flex items-center justify-center">
              <div className="w-full tablet:max-w-[947px] max-w-[360px] h-56 flex justify-center items-center rounded-2xl border border-disabled border-dashed mx-4">
