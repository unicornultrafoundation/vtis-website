  ...
  return (
    <>
      <div className="w-full h-full bg-black">
        <div className=" pt-8 pb-[99px] tablet:pb-0 tablet:pt-[11px] w-full tablet:h-[500px] fullscreen:h-[1336px] gap-16 tablet:gap-0 bg-black bg-[url('/images/section5/section5-bg.png')] bg-cover] bg-cover bg-center text-white flex flex-col tablet:flex-row tablet:justify-between items-center tablet:border-b border-[#333333]">
          {/* Left / Top */}
      ...
      <div className="bg-[#000000] flex flex-col gap-[62px] tablet:gap-[72px] fullscreen:gap-[213px] px-4 tablet:px-8 py-[64px] tablet:py-[72px] fullscreen:py-[192px] border-b border-[#333333]">
        {/* Header */}
        ...
        <div className="w-full flex flex-col gap-8">
          ...
          <div className="w-full flex gap-3 tablet:gap-0 flex-wrap tablet:flex-nowrap justify-between pt-6 pb-[72px] border-t border-[#333333]">
            <p className="animated-text text-white text-base">01</p>
            <p className="animated-text animated-text-delay-0.2s p-1 border h-[28px] text-white text-xl flex items-center">
              Vision
            </p>
            <p className="animated-text animated-text-delay-0.4s w-[480px] text-white text-xl font-medium">
          ...
          <div className="w-full flex gap-3 tablet:gap-0 flex-wrap tablet:flex-nowrap justify-between pt-6 pb-[72px] border-y border-[#333333]">
            <p className="animated-tex text-white text-base">02</p>
            <p className="animated-text animated-text-delay-0.2s p-1 border h-[28px] text-white text-xl flex items-center">
              Mission
            </p>
            <p className="animated-text animated-text-delay-0.4s w-[480px] text-white text-xl font-medium">
        ...
        <div className="w-full flex flex-col gap-6 justify-center items-center">
          <ImageBase.FPTLogo className="animated-text" width={87} />
          <p className="animated-text animated-text-delay-0.5s laptop:w-[1061px] text-white text-3xl tablet:text-5xl text-center">
