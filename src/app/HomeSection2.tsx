        ...
        <div className="w-[50%] max-[768px]:w-full max-[768px]:pb-8 flex flex-col items-start justify-start max-[768px]:px-0">
          ...
          <div className="flex gap-2 tablet:gap-3">
            ...
            <button className="relative group overflow-hidden bg-white hover:bg-[#2FD3DD] transition-all duration-500">
              ...
              />
              <div
                className="absolute inset-y-0 left-5 text-black group-hover:-translate-y-[2.7rem] transition-all duration-500 ease-in-out flex flex-col items-center gap-5 top-3 fullscreen:top-8 fullscreen:text-[43px] font-neueMed fullscreen:group-hover:-translate-y-[6rem] fullscreen:left-12"
                // style={{
