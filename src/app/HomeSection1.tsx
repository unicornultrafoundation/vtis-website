    ...
    <div className="w-full flex flex-col">
      <div className="w-full flex px-4 py-6 tablet:py-5 items-end max-[768px]:flex-col max-[768px]:gap-4">
        <div className="w-[60%] h-full flex flex-col gap-2 max-[768px]:w-full">
          <div className="w-full font-neueMed text-[20px] max-[768px]:text-[16px] fullscreen:text-[53px] fullscreen:text-nowrap">
            3-4 DECEMBER, 2024 - NATIONAL CONVENTION CENTER, HANOI, VIETNAM
          </div>
          <div className="w-full h-full font-medium font-neueMed text-[88px] max-[768px]:text-[40px] fullscreen:text-[234px] fullscreen:leading-[234px] max-[768px]:leading-[40px] leading-[88px]">
            Vietnam Tech
            <br />
            Impact Summit 2024
          </div>
